...
(redex-match L e sample-expr-1)

(define sample-expr-2 (term ((if (== 3 4) (+ 2 2) (* 3 4)))))
(redex-match L e sample-expr-2)

(define sample-expr-3 (term ((+ "The answer is " 42))))
(redex-match L e sample-expr-3)

(define sample-stat-1 (term ((println (+ "The answer is " 42)))))

; a statement is not an expression:
; (redex-match L e sample-stat-1)

(redex-match L prog sample-stat-1)

(redex-match L stat_1 sample-stat-1)
